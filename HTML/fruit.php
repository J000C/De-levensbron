...
<?php if(isset($_SESSION["admin"])&& $_SESSION["admin"]=="True"&&(isset($_SESSION['loggedin']) == "True" )) { ?> <div class="column <?php print $row["Oorsprong"]?>">
        <div class="content">
          <a href="../Images/fruit/<?php echo $row["Naam"]?>.jpg" ><img class="magic_wizzard" src="../Images/fruit/<?php echo $row["Naam"]?>.jpg"  alt="<?php print $row["Oorsprong"]?>" style="width:100%"> </a>
